...
###生成一个submission_file
filepath = "./select_type_B_feature_result_xgb6/"
...
for filename in file_names:
    ...
    selected_df["serial_number_type"] = "B"
...
filtered_df.to_csv("submission_B_224_baseline_xgb" + horizon.replace(".", "") + ".csv", index=False)
